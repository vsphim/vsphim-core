...
@php
    $widgets['before_content'] = [
        [
            ...
            'heading' => 'VsphimCMS - Tạo website xem phim miễn phí vĩnh viễn',
            'content' =>
                '
                Phiên bản: <span class="text-danger text-break">' .
                config('vsphim.version') .
                '</span><br/>
                Trang chủ: <a href="https://vsphim.com">vsPhim.Com</a><br/>
                Dữ liệu phim miễn phí: <a href="https://t.me/vsphimcom">Tham gia nhóm Telegram</a>
            ',
