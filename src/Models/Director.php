...
namespace Vsphim\Core\Models;

use Backpack\CRUD\app\Models\Traits\CrudTrait;
use Backpack\Settings\app\Models\Setting;
use Vsphim\Core\Contracts\TaxonomyInterface;
use Vsphim\CachingModel\Contracts\Cacheable;
use Vsphim\CachingModel\HasCache;
use Illuminate\Database\Eloquent\Model;
use Vsphim\Core\Contracts\SeoInterface;
use Vsphim\Core\Traits\HasFactory;
use Vsphim\Core\Traits\HasTitle;
use Vsphim\Core\Traits\HasDescription;
use Vsphim\Core\Traits\HasKeywords;
use Vsphim\Core\Traits\HasUniqueName;
use Vsphim\Core\Traits\Sluggable;
