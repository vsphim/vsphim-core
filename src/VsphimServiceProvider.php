...
use Vsphim\Core\Policies\PermissionPolicy;
use Vsphim\Core\Policies\RolePolicy;
use Vsphim\Core\Policies\UserPolicy;
use Illuminate\Foundation\Support\Providers\AuthServiceProvider as ServiceProvider;
use Illuminate\Support\Facades\DB;
use Vsphim\Core\Console\CreateUser;
use Vsphim\Core\Console\InstallCommand;
use Vsphim\Core\Console\GenerateMenuCommand;
use Vsphim\Core\Console\ChangeDomainEpisodeCommand;
use Vsphim\Core\Middleware\CKFinderAuth;
...
use Vsphim\Core\Policies\ActorPolicy;
use Vsphim\Core\Policies\CatalogPolicy;
use Vsphim\Core\Policies\CategoryPolicy;
use Vsphim\Core\Policies\CrawlSchedulePolicy;
use Vsphim\Core\Policies\DirectorPolicy;
use Vsphim\Core\Policies\EpisodePolicy;
use Vsphim\Core\Policies\MenuPolicy;
use Vsphim\Core\Policies\MoviePolicy;
use Vsphim\Core\Policies\RegionPolicy;
use Vsphim\Core\Policies\StudioPolicy;
use Vsphim\Core\Policies\TagPolicy;

class VsphimServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->mergeConfigFrom(__DIR__ . '/../config/config.php', 'vsphim');
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../resources/views/core/', 'vsphim');
    ...
    protected function publishFiles()
    {
        $backpack_menu_contents_view = [
            __DIR__ . '/../resources/views/core/base/'  => resource_path('views/vendor/vsphim/base/'),
            __DIR__ . '/../resources/views/core/crud/'      => resource_path('views/vendor/vsphim/crud/'),
        ];
        ...
        $this->publishes([
            __DIR__ . '/../config/config.php' => config_path('vsphim.php')
        ], 'config');
    }
    ...
    protected function mergeBackpackConfigs()
    {
        ...
        config(['cachebusting_string' => \PackageVersions\Versions::getVersion('vsphim/crud')]);

        config(['backpack.base.project_logo' => '<b>Vsphim</b>CMS']);
        config(['backpack.base.developer_name' => 'vsphim']);
        config(['backpack.base.developer_link' => 'mailto:vsphim@example.com']);
    ...
    protected function mergeCkfinderConfigs()
    {
        ...
        config(['ckfinder.backends.default' => config('vsphim.ckfinder.backends')]);
    }
