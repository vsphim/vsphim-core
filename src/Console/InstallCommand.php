...
namespace Vsphim\Core\Console;

use Backpack\Settings\app\Models\Setting;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\Artisan;
use Vsphim\Core\Database\Seeders\CatalogsTableSeeder;
use Vsphim\Core\Database\Seeders\CategoriesTableSeeder;
use Vsphim\Core\Database\Seeders\MenusTableSeeder;
use Vsphim\Core\Database\Seeders\PermissionsSeeder;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'vsphim:install';
     ...
     * @var string
     */
    protected $description = 'Install Vsphim';
    ...
    public function handle()
    {
        ...
        $this->newLine(1);
        $this->info('Vsphim installation finished.');
